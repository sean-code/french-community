        ...
        <div className='blogs'>
            <CardGroup className='blog-groups'>
                <Card className='blog-cards'>
                    <Card.Img className='blog-images' variant="top" src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8QmxhY2slMjBDb21tdW5pdHl8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
                    <Card.Body>
