    ...
    <div className='why-cards'>
        <CardGroup>
            <Card className='card-components'>
                ...
                <Card.Body>
                <Card.Title style={{ fontWeight:'700', textAlign:'center'}}>Team Players</Card.Title>
            ...
            <Card className='card-components'>
                ...
                <Card.Body>
                <Card.Title style={{fontWeight:'700', textAlign:'center'}}>Affordability</Card.Title>
                <Card.Text className='card-text'>
        ...
        <CardGroup>
            <Card className='card-components'>
                ...
                <Card.Body>
                <Card.Title style={{fontWeight:'700', textAlign:'center'}}>Fun and Interactive</Card.Title>
                <Card.Text className='card-text'>
            ...
            <Card className='card-components'>
                ...
                <Card.Body>
                <Card.Title style={{fontWeight:'700', textAlign:'center'}}>French in French</Card.Title>
                <Card.Text className='card-text'>
